...
# Purpose: Create EMR bootstrap script(s) bucket and create Stack 
...
sts_client = boto3.client('sts') #AWS Security Token Service (STS)
...
#logging.basicConfig(filename='app-s3.log', filemode='w',format='[%(asctime)s] %(levelname)s - %(message)s', level=logging.INFO)
